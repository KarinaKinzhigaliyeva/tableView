...
//    var arrayNames = ["Sheldon", "Leonard", "Penny", "Howard", "Rajesh"]
//
//    var arraySurnames = ["Cooper", "Hofstadter", "Teller", "Wolowitz", "Koothrappali"]
//
//    var arrayImages = ["sheldon", "leonard", "penny", "howard", "rajesh"]
//
    
    var arrayPersons = [Person(name: "Sheldon", surname: "Cooper", imagename: "sheldon"),
    Person(name: "Leonard", surname: "Hofstadter", imagename: "leonard"),
    Person(name: "Penny", surname: "Teller", imagename: "penny"),
    Person(name: "Howard", surname: "Wolowitz", imagename: "howard"),
    Person(name: "Rajesh", surname: "Koothrappali", imagename: "rajesh")]
